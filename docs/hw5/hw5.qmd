...
## Exercise 2: Deconstructing a Graphic

#### **a. Copy of the graphic**

![Marginal distribution added on X and Y axis of a scatter plot](https://r-graph-gallery.com/277-marginal-histogram-for-ggplot2_files/figure-html/unnamed-chunk-1-1.png){width="70%" fig-align="center"}

[Reference: Marginal distribution with ggplot2 and ggExtra](https://r-graph-gallery.com/277-marginal-histogram-for-ggplot2.html)
...
#### **1 ) high temperature in Seattle each day**
...
#### **2) mean temperature for each month**

The graphic should show 12 months.
